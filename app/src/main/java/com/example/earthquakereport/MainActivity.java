...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<EarthQuakeDetails>>
{
   ...
   /* private static final String USGS_REQUEST_URL =
    ...
    /*@Override
    protected void onCreate(Bundle savedInstanceState) //This onCreate() method was used before using Networking
    {
...
//        earthquakes.add(new EarthQuakeDetails("7.2","San Francisco","Feb 2,2016"));
//        earthquakes.add(new EarthQuakeDetails("6.1","London","Feb 2,2016"));
//        earthquakes.add(new EarthQuakeDetails("3.9","Tokyo","Feb 2,2016"));
//        earthquakes.add(new EarthQuakeDetails("5.4","Mexico City","Feb 2,2016"));
//        earthquakes.add(new EarthQuakeDetails("2.8","Moscow","Feb 2,2016"));
//        earthquakes.add(new EarthQuakeDetails("4.9","Rio de Janerio","Feb 2,2016"));
//        earthquakes.add(new EarthQuakeDetails("1.6","Paris","Feb 2,2016"));
        ...
        earthquakeListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l)
            {
                ...
                EarthQuakeDetails currentEarthquake=adapter.getItem(position);//getIten() returns the items's data object..It provides a way for you to access data in the adapter.

                //Convert String object (to pass into the Intent Constructor)
...
//     */
//
//    public class EarthquakeAsyncTask extends AsyncTask<String,Void, List<EarthQuakeDetails>>
//    {
//        /**
//         * This method runs on a background thread and performs the network request.
//         * We should not update the UI from a background thread, so we return a list of
//         * {@link EarthQuakeDetails}s as the result.
//         */
//        @Override
...
//                return null;
//            }
//            List<EarthQuakeDetails> result=QueryUtils.fetchEarthquakeData(urls[0]);
//            return result;
//        }
//
//        /**
...
//         */
//        @Override
//        protected void onPostExecute(List<EarthQuakeDetails> data)
//        {
//            //N Reference the adapter in the EarthquakeAsyncTask onPostExecute() method.
